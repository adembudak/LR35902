#include <LR35902/cartridge/kind/mbc1/mbc1_2mb.h>
...
byte mbc1_2mb::readROM(const std::size_t index) const noexcept {
  if(index < mmap::rom0_end) {
    ...
    if(register_3 == 0) return portions[register_2][register_1][normalized_index];
    else return portions[0][register_1][normalized_index];
  }
