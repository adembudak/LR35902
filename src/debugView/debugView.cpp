...
bool showMemoryPortionsFlag{true};

void DebugView::showMemoryPortions() const noexcept {
  using namespace ImGui;

  Begin("Memory Portions", &showMemoryPortionsFlag);
...
void DebugView::showDisassembly() const noexcept {
  using namespace ImGui;
...
void DebugView::showCPUState() const noexcept {
  using namespace ImGui;

  Begin("CPU State", &showCpuRegisters, ImGuiWindowFlags_NoResize);
...
void DebugView::showRegisters() const noexcept {
  using namespace ImGui;

  Begin("Registers", &showRegisters_);
...
void DebugView::showCartridgeHeader() const noexcept {
  using namespace ImGui;

  Begin("Cartridge Header");
